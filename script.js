class AdventCalendar {
    constructor() {
        ...
        this.challenges = [
            ...
            { day: 5, title: "5 Golden Kms", content: "Run, Walk, or Cycle, 5 Golden Kms" },
            ...
            { day: 11, title: "The Festive Farmers", content: "11 Lengths of Farmers carries" },
    ...
    generateRandomExercise(exerciseNumber) {
        // Initialize audio when user clicks exercise button (user interaction)
    ...
    startBopItGame() {
        ...
        // Initialize audio when user starts the game (user interaction)
        this.initializeAudio();
